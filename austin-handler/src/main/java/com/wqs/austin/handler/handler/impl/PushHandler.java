...
import com.wqs.austin.common.dto.account.GeTuiAccount;
import com.wqs.austin.common.dto.model.PushContentModel;
import com.wqs.austin.common.enums.ChannelType;
import com.wqs.austin.handler.domain.push.PushParam;
import com.wqs.austin.handler.domain.push.getui.BatchSendPushParam;
import com.wqs.austin.handler.domain.push.getui.SendPushParam;
import com.wqs.austin.handler.domain.push.getui.SendPushResult;
...
/**
 * 通知栏消息发送处理(目前具体的实现是个推服务商，安卓端已验证)
 * author: wqs
